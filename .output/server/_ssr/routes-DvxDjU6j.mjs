...
import { a as Sparkles, c as PawPrint, d as Linkedin, f as Github, h as ArrowUpRight, i as Sun, l as Moon, m as BatteryCharging, n as Users, o as ShieldAlert, p as FileSearchCorner, r as Terminal, s as Phone, t as X, u as Mail } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DvxDjU6j.js
...
var NUMBERS = [
	...
	},
	{
		v: 7,
		suffix: " mo",
		label: "internship in prod"
	},
	{
		v: 4,
		suffix: "",
		label: "complex apps built"
	},
	{
		v: 30,
		suffix: "%",
...
var EDUCATION = [{
	...
	detail: "B.Tech, Information Technology - CGPA 7.85",
	date: "2023 - 2027"
}, {
	school: "K.G. Matric Hr. Sec. School",
	detail: "HSC, Computer Science - 90.67%",
	date: "2022 - 2023"
}];
var CERTS = [
	{
		name: "OCI AI Foundations Associate",
		date: "Passed - Jun 2026",
		status: "done"
	},
	{
		name: "Microsoft Azure AI-900",
		date: "In progress - target Oct 2026",
		status: "wip"
	},
	{
...
function Rise({ children, delay = 0, y = 18, className, style }) {
	const ref = (0, import_react.useRef)(null);
	const [shown, setShown] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const el = ref.current;
...
function Rule({ delay = 0, color = "var(--rule)" }) {
	const ref = (0, import_react.useRef)(null);
...
function CustomCursor() {
	...
	const rpos = (0, import_react.useRef)({
		x: -100,
		y: -100
	});
	...
	(0, import_react.useEffect)(() => {
		...
		let raf = 0;
		const loop = () => {
			rpos.current.x += (pos.current.x - rpos.current.x) * .18;
			rpos.current.y += (pos.current.y - rpos.current.y) * .18;
			scale.current += (target.current - scale.current) * .15;
...
function InteractiveRadar({ activeAxis, setActiveAxis }) {
	...
	const updateCoords = (e) => {
		...
		if (Math.hypot(targetX, targetY) < 15) setActiveAxis("balanced");
		else if (min === distToSde) setActiveAxis("sde");
		else if (min === distToAi) setActiveAxis("ai");
		else setActiveAxis("fullstack");
	};
	const values = (0, import_react.useMemo)(() => {
		const sdePct = Math.max(0, Math.min(100, Math.round(50 - coords.y * .7 + (activeAxis === "sde" ? 10 : 0))));
		const aiPct = Math.max(0, Math.min(100, Math.round(25 + coords.y * .35 + coords.x * .6 + (activeAxis === "ai" ? 10 : 0))));
		const fsPct = Math.max(0, Math.min(100, Math.round(25 + coords.y * .35 - coords.x * .6 + (activeAxis === "fullstack" ? 10 : 0))));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [
						...
						Object.entries(vertices).map(([key, node]) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
								...
								cy: node.y,
								r: isSel ? 7 : 4,
								fill: isSel ? markerColor : "var(--ink)",
								...
								children: node.label.toUpperCase()
							})] }, key);
						}),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							style: {
								fontSize: 18,
								fontWeight: 600,
								color: activeAxis === "sde" ? SKILLS_CATEGORIES.sde.color : "inherit"
							},
							children: [values.sde, "%"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mono",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							style: {
								fontSize: 18,
								fontWeight: 600,
								color: activeAxis === "ai" ? SKILLS_CATEGORIES.ai.color : "inherit"
							},
							children: [values.ai, "%"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mono",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						style: {
							fontSize: 18,
							fontWeight: 600,
							color: activeAxis === "fullstack" ? SKILLS_CATEGORIES.fullstack.color : "inherit"
						},
						children: [values.fs, "%"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mono",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: "Drag the target to adjust your focus"
			})
		]
	});
}
function TerminalConsole() {
	const [history, setHistory] = (0, import_react.useState)([{
		cmd: "help",
		res: "Available commands: about, skills, projects, contact, matrix, clear"
	}]);
	...
	const [matrixActive, setMatrixActive] = (0, import_react.useState)(false);
	const termBodyRef = (0, import_react.useRef)(null);
	const handleCommand = (e) => {
		...
		if (cleanCmd === "clear") {
			...
			response = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				"Shanjai M R - Software Engineer specializing in Full-Stack and Applied AI.",
			...
			response = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Java, C++, DSA, OOP, Systems, MySQL, PostgreSQL, Git" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: { color: "var(--olive)" },
						children: "[AI/ML]"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Python, Gemini API, LangChain, RAG, scikit-learn, NLP" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: { color: "var(--muted)" },
						children: "[FullStack]"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "React, Next.js, TypeScript, Node.js, FastAPI, Flask, REST" })
				]
			});
			setMatrixActive(false);
		} else if (cleanCmd === "projects") {
			response = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				"- Wildlife Rescue: Triage coordinator with Gemini Vision.",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
				"- ChargeIQ EV: Diagnostics tool using LangChain and RAG.",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
				"- AI Job Predictor: Screening engine using FastAPI.",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
			...
			setMatrixActive(false);
		} else response = `Command not recognized: '${cleanCmd}'. Type 'help' for options.`;
	...
	const onPointerDown = (e) => {
		if (e.target.closest(".term-controls") || e.target.closest("input")) return;
		isDragging.current = true;
		dragStart.current = {
			x: e.clientX - pos.x,
			y: e.clientY - pos.y
	...
	if (!isOpen) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Terminal, { size: 22 })
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		onPointerMove,
		onPointerUp,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				matrixActive && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						position: "absolute",
						inset: 0,
						pointerEvents: "none",
					...
					children: Array(10).fill(0).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: Array(15).fill(0).map(() => String.fromCharCode(33 + Math.floor(Math.random() * 93))).join("\n")
					}, i))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "shanjai_os v1.0.4 - Initialized successfully." }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Type 'help' to begin." }),
				history.map((h, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: { marginTop: 8 },
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: { color: "var(--muted)" },
							children: "$"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: h.cmd })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							marginTop: 2,
							color: "#fff",
...
function BentoProjectCard({ project, index, activeAxis }) {
	const [subTab, setSubTab] = (0, import_react.useState)("sde");
	const Icon = project.icon;
	(0, import_react.useEffect)(() => {
		if (activeAxis === "sde" || activeAxis === "ai" || activeAxis === "fullstack") setSubTab(activeAxis);
	}, [activeAxis]);
	const [evSoh, setEvSoh] = (0, import_react.useState)(90);
	const [evTemp, setEvTemp] = (0, import_react.useState)(25);
	const [wildlifeSample, setWildlifeSample] = (0, import_react.useState)(null);
	const [wildlifeStatus, setWildlifeStatus] = (0, import_react.useState)("idle");
	const [jobSelect, setJobSelect] = (0, import_react.useState)("fs");
	const [jobScore, setJobScore] = (0, import_react.useState)(null);
	const [jobKeywords, setJobKeywords] = (0, import_react.useState)([]);
	const [bookedSlots, setBookedSlots] = (0, import_react.useState)([]);
	const [conflictWarning, setConflictWarning] = (0, import_react.useState)(null);
	const simulatedEvRange = (0, import_react.useMemo)(() => {
		const base = 320;
		const sohFact = evSoh / 100;
		const tempFact = 1 - Math.abs(evTemp - 25) * .005;
		return Math.round(base * sohFact * tempFact);
	}, [evSoh, evTemp]);
	const wildlifeDetails = [
		{
			name: "Injured Deer (Fawn)",
			desc: "Slight limp reported near boundary line.",
			species: "Cervus elaphus",
			issue: "Splint Fracture",
			triage: "URGENT",
			status: "Critical"
		},
		{
			name: "Stray Golden Eagle",
			desc: "Found grounded near fields, wing drooping.",
			species: "Aquila chrysaetos",
			issue: "Lead Poisoning / Wing Sprain",
			triage: "CRITICAL",
			status: "Immediate Dispatch"
		},
		{
			name: "Sea Turtle Nest",
			desc: "Erosion exposing eggs near coastal road.",
			species: "Cheloniidae",
			issue: "Nesting Hazard",
			triage: "MODERATE",
			status: "Scheduled Transfer"
		}
	];
	const handleWildlifeAnalyze = (idx) => {
	...
	const scheduleMeeting = (slotIdx) => {
		setConflictWarning(null);
		if (slotIdx === 2) setConflictWarning("Constraint Engine Conflict: Room 302 booked by AI-Lab during this hour. Smart auto-shifted to virtual Zoom link.");
		if (bookedSlots.includes(slotIdx)) setBookedSlots(bookedSlots.filter((s) => s !== slotIdx));
		else setBookedSlots([...bookedSlots, slotIdx]);
	};
	const timeSlots = [
		"09:00 AM",
		"11:00 AM",
		"02:00 PM (Lab Conflict Slot)",
		"04:30 PM"
	];
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
		delay: index * 120,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: tab === "sde" ? "SDE CORE" : tab === "ai" ? "APPLIED AI" : "FULL-STACK"
						}, tab);
					})
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { size: 11 }), " LIVE PLAYGROUND WIDGET"]
						}),
						project.id === "wildlife" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
								gap: 10
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: wildlifeDetails.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: ["Sample #$", idx + 1]
								}, idx))
							}), wildlifeSample !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									padding: 8,
								...
								children: wildlifeStatus === "running" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mono",
									style: {
										fontSize: 10,
										display: "flex",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "spinning-symbol",
										children: "\\u25e1"
									}), " Orchestrating Gemini API Classifier..."]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: wildlifeDetails[wildlifeSample].name
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "mono",
											style: {
												fontSize: 9,
											...
											children: wildlifeDetails[wildlifeSample].triage
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mono",
										...
										children: [
											"Model output: ",
											wildlifeDetails[wildlifeSample].species,
											" (",
											wildlifeDetails[wildlifeSample].issue,
											")"
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											"↳ Dispatcher node: ",
											wildlifeDetails[wildlifeSample].status,
											" logged to MySQL."
										]
									})
								] })
						...
						project.id === "charge" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
								gap: 12
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									className: "mono",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "SoH:" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									className: "mono",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Ambient:" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										style: { fontWeight: "bold" },
										children: [evTemp, "°C"]
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: [simulatedEvRange, " miles"]
								})]
							})]
						}),
						project.id === "job" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
								gap: 10
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
											value: "fs",
											children: "Full-Stack dev JD"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
											value: "ai",
											children: "Applied AI developer JD"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
											value: "sde",
											children: "Core Systems Engineer JD"
										})
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: "Parse Resume"
								})]
							}), jobScore !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									padding: 8,
									background: "rgba(0,0,0,0.02)",
									borderRadius: 6
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Matched keys:" }), jobKeywords.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										style: { color: "var(--olive)" },
										children: k
									}, k))]
								})]
						...
						project.id === "meets" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
								gap: 8
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: timeSlots.map((slot, idx) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: "mono",
										children: [
											idx === 2 ? "02:00 PM (Conflict)" : slot,
											" ",
											isBooked ? "✓" : ""
										]
									}, idx);
								})
							}), conflictWarning && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									gap: 6,
									padding: 6,
...
function Constellation({ activeAxis }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const move = (e) => {
			...
			drag.current.lx = e.clientX;
			drag.current.ly = e.clientY;
			rot.current.y += dx * .005;
			rot.current.x += dy * .005;
			rot.current.vy = dx * 4e-4;
			rot.current.vx = dy * 4e-4;
		};
		const up = (e) => {
			...
			if (Math.abs(rot.current.vy) < 8e-4) rot.current.vy = .0022;
		};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			...
			const s = .65 + r.depth * .55;
			const op = .3 + r.depth * .7;
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				style: {
					...
					opacity: isHov ? 1 : isActiveCat ? op : op * .25,
					whiteSpace: "nowrap",
...
function Portfolio() {
	const [activeAxis, setActiveAxis] = (0, import_react.useState)("balanced");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			["--bg"]: theme === "dark" ? "#0A0908" : "#EDE7DA",
			["--ink"]: theme === "dark" ? "#F5F2EB" : "#141110",
			["--muted"]: theme === "dark" ? "#8E867A" : "#6E655A",
			["--rule"]: theme === "dark" ? "#262421" : "#CFC7B6",
			["--accent"]: theme === "dark" ? "#E05A47" : "#B0432B",
			["--olive"]: theme === "dark" ? "#8E9A68" : "#6B7355",
			["--card-bg"]: theme === "dark" ? "#121110" : "#F5EFE4",
			["--card-border"]: theme === "dark" ? "rgba(245,242,243,0.08)" : "rgba(20,17,16,0.08)",
			minHeight: "100vh",
			background: "var(--bg)",
			color: "var(--ink)",
			position: "relative",
        ...
        * { box-sizing: border-box; }
        ...
        .paper-noise::before {
          content: ""; position: absolute; inset: 0; pointer-events: none; opacity: ${theme === "dark" ? .08 : .22};
      ...
      ` }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollLine, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: ["Shanjai ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								style: {
									fontStyle: "italic",
									fontWeight: 400
								},
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Rise, {
									delay: 400,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "kicker",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											children: "I build products at the intersection of core software systems, machine intelligence, and complete user interfaces. Java and Python at the core, 350+ algorithms deep, seven months shipping production features end-to-end."
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												display: "flex",
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Magnetic, {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
													...
													children: ["Start a conversation", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { size: 16 })]
												})
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
												href: "https://github.com/Shanjai24",
												target: "_blank",
												rel: "noreferrer",
												"data-hover": true,
												className: "mono link-u",
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InteractiveRadar, {
									activeAxis,
									setActiveAxis
								})
							})]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
								delay: 500,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										display: "grid",
									...
									children: NUMBERS.map((n, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "serif",
										style: {
											fontSize: 32,
											fontWeight: 500,
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
								delay: 550,
								style: {
									display: "flex",
									justifyContent: "flex-end"
								},
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TerminalConsole, {})
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: Array(2).fill(0).map((_, k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									display: "flex",
									gap: 56,
									paddingRight: 56
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
						n: "02",
						kicker: "Standards",
						title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["The way ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							style: { color: "var(--accent)" },
							children: "I work."
						})] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Rise, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "serif",
							style: {
								fontSize: 20,
								lineHeight: 1.55,
							...
							children: "Five core principles that drive my architecture, pull requests, and debugging. Not aesthetic rules, but engineering standards that make code reliable at scale."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mono",
							style: {
								marginTop: 32,
							...
							children: "- THE SHANJAI STANDARD"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [STANDARDS.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
							delay: i * 90,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									padding: "22px 0",
						...
						}, s.n)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rule, {})] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
						n: "03",
						kicker: "Unified Case Files",
						title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Selected ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							style: { color: "var(--accent)" },
							children: "products."
						})] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: PROJECTS.map((project, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BentoProjectCard, {
							project,
							index: idx,
							activeAxis
						}, project.id))
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
						n: "04",
						kicker: "The Toolbox Sphere",
						title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["All technologies ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							style: { color: "var(--accent)" },
							children: "deployed."
						})] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Rise, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "An interactive 3D constellation of every language, framework, database, and model I have written and shipped."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								marginTop: 32,
								display: "flex",
							...
							children: Object.entries(SKILLS_CATEGORIES).map(([key, cat]) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: [cat.skills.length.toString().padStart(2, "0"), " skills"]
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mono",
										style: {
										...
										children: [cat.skills.slice(0, 7).join(", "), "..."]
									})]
								}, key);
							})
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
							delay: 120,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Constellation, { activeAxis })
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
						n: "05",
						kicker: "Professional Log",
						title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Shipped in ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							style: { color: "var(--accent)" },
							children: "production."
						})] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Rise, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "grid",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [EXPERIENCE.period.split("-")[0].trim(), " -"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mono",
										style: {
										...
										children: EXPERIENCE.period.split("-")[1].trim()
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mono",
										style: {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
										...
										children: EXPERIENCE.notes.map((n, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
											style: {
												display: "grid",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "Agile cycle completion rate across seven months of shipped React and REST integrations."
									})
								] })
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rule, {})] })
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
						n: "06",
						kicker: "Credentials",
						title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Academic & ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							style: { color: "var(--accent)" },
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							EDUCATION.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
								delay: i * 90,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										padding: "22px 0",
							...
							CERTS.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
								delay: i * 70,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										padding: "18px 0",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											style: {
												fontSize: 10.5,
												color: c.status === "done" ? "var(--accent)" : "var(--muted)",
												letterSpacing: 1.2
											},
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: ["Shortlisted - Amazon ML Summer School ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "accent",
												children: "2026"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: "Selected through coding assessment and resume/SOP review, completing coursework in computer vision and deep learning."
										})
									]
								})
							})
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineReveal, { children: "Let's build" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineReveal, {
											delay: 140,
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												style: {
													fontStyle: "italic",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Magnetic, {
											strength: .35,
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												href: "mailto:shanjaimr245@gmail.com",
												"data-hover": true,
												style: {
													display: "inline-flex",
													alignItems: "center",
									...
									[
										{
											Icon: Github,
											label: "github.com/Shanjai24",
											href: "https://github.com/Shanjai24"
										},
										{
											Icon: Linkedin,
											label: "linkedin.com/in/shanjaimr",
											href: "https://linkedin.com/in/shanjaimr"
										},
										{
											Icon: Phone,
											label: "+91 86828 59436",
											href: "tel:+918682859436"
										}
									].map(({ Icon, label, href }, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rise, {
										delay: i * 80,
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											href,
											target: "_blank",
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												size: 18,
												strokeWidth: 1.4,
												style: { transition: "transform .4s cubic-bezier(.2,.7,.15,1)" }
											})]
										})
									}, label)),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rule, {})
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Colophon -" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Set in Fraunces & Inter Tight." }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Built with React & Tailwind. Draggable CLI included." })
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mono",
									style: {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										...
										" S.M.R"
									] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Coimbatore - IN" })]
								})]
							})
						]
					})
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineReveal, { children: title })
			})
		] })]
	});
}
